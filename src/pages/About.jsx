      ...
      <div className="container">
        ...
        <div className="row text-center mb-5 section">
          <div className="mx-auto" style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <p className="lead text-muted" style={{ fontSize: '1.2rem', lineHeight: '1.8' }}>
              Land24 was founded on a simple principle: buying a home should be as beautiful as the home itself. We combine world-class technology with elite agents to deliver an unparalleled real estate experience for discerning clients worldwide.
            </p>
          </div>
        </div>
        ...
        <div className="section mt-5 pt-5">
          <div className="text-center mb-5">
            ...
            <p className="text-muted text-center" style={{ marginBottom: '3rem' }}>The visionaries behind Land24.</p>
          </div>
