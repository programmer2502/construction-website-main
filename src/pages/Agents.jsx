    ...
    <div className="agents-page animate-fade-in" style={{ paddingTop: '100px', paddingBottom: '5rem' }}>
      <div className="container">
        ...
        <div className="text-center mt-5 pt-4 border-top" style={{ borderTop: '1px solid var(--color-border)', marginTop: '4rem', paddingTop: '4rem' }}>
          ...
          <p className="text-muted mb-4" style={{ maxWidth: '600px', margin: '0 auto 2rem' }}>We are always looking for driven, experienced professionals to join PropVista. If you have what it takes to deliver premium service, we want to hear from you.</p>
